...
selected_quarter = st.selectbox("Select Quarter", ["ALL", "1", "2", "3", "4"])
...
def fetch_top_10_records(data_type, table_name, selected_state, selected_year, selected_quarter):
    ...
    if selected_year:
        ...
        if selected_quarter and selected_quarter != "ALL" and data_type == "transaction":
...
df_top_10 = fetch_top_10_records(data_type, selected_table, selected_state, selected_year, selected_quarter)
